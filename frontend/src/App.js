...
function App() {
  ...
  const onHandleDeleteProduct = (uuid) => {
    fetch(`http://localhost:8080/api/products/${uuid}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    <>
      ...
      <div className="row">
        ...
        {products.map((element) => (
          <div className="card col-2 m-3" key={element.uuid}>
            <img
            ...
            <div className="card-body">
              ...
              <button
                ...
                onClick={() => {
                  onHandleDeleteProduct(element.uuid);
                }}
              >
                Eliminar
              </button>
